...
def main():
    ...
    def load_data():
        data = pd.read_csv("F:/Program/Python/streamlit-ml/mushrooms.csv")
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        #choose parameters
        C = st.sidebar.number_input("C (Regularization parameter)", 0.01, 10.0, step=0.05, key='C_SVM')
    ...
    if classifier == 'Logistic Regression':
        st.sidebar.subheader("Model Hyperparameters")
        C = st.sidebar.number_input("C (Regularization parameter)", 0.01, 10.0, step=0.05, key='C_LR')
        max_iter = st.sidebar.slider("Maximum number of iterations (100-1000)", 100, 1000, key='max_iter')
    ...
    if classifier == 'Random Forest':
        st.sidebar.subheader("Model Hyperparameters")
        n_estimators = st.sidebar.number_input("The number of trees in the forest (100-5000)", 100, 5000, step=100, key='n_estimators')
        max_depth = st.sidebar.number_input("The maximum depth of the tree (1-20)", 1, 20, step=1, key='n_estimators')
